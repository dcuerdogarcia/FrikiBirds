...
public class Movimiento_Pajaro extends Thread {
    ...
    public Movimiento_Pajaro(Juego parent) {
        this.velocidad = 10;
        this.parent = parent;
    }
    ...
    public void run() {
        ...
        while (true) {
            ...
            int x = Juego.jPajaro.getLocation().x;
            if (!isSaltar()) {
                int y = Juego.jPajaro.getLocation().y;
                try {
                    Thread.sleep(getVelocidad());
                    Juego.jPajaro.setLocation(x, (y + 1));
                    if (velocidad > 3) {
                        if (varA % 15 == 0) {
